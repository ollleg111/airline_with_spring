...
@Component
public class FilterPlaneModelsList extends Criteria {
    private FlightService flightService;

    @Autowired
    public FilterPlaneModelsList(FlightService flightService) {
    ...
    public List<Flight> criteriaFlights() {
        return flightService.planeModelsList(getFilter().getPlaneModel());
    }
}
